...
void DryLand::processChannel(int c, Input& in, Output& lpfOut, Output& hpfOut) {
...
struct DryLandModuleWidget : ModuleWidget {
	DryLandModuleWidget(DryLand* module) {
		...
		addParam(createParam<RPJKnobBig>(Vec(knobX2, knobY2), module, DryLand::PARAM_FC));
		addParam(createParam<RPJKnob>(Vec(knobX3, knobY1), module, DryLand::PARAM_CVFC));
		addParam(createParam<RPJKnobBig>(Vec(knobX2, knobY4), module, DryLand::PARAM_DRIVE));
		addParam(createParam<RPJKnob>(Vec(knobX3, knobY3), module, DryLand::PARAM_CVDRIVE));
		addParam(createParam<RPJKnob>(Vec(knobX1, knobY5), module, DryLand::PARAM_WET));
		addParam(createParam<RPJKnob>(Vec(knobX4, knobY5), module, DryLand::PARAM_DRY));
		...
		addInput(createInput<PJ301MPort>(Vec(jackX2, jackY3), module, DryLand::INPUT_MAIN));
		addOutput(createOutput<PJ301MPort>(Vec(jackX1, jackY4), module, DryLand::OUTPUT_LPFMAIN));
		addOutput(createOutput<PJ301MPort>(Vec(jackX3, jackY4), module, DryLand::OUTPUT_HPFMAIN));
		addInput(createInput<PJ301MPort>(Vec(jackX3, jackY1), module, DryLand::INPUT_CVFC));
		addInput(createInput<PJ301MPort>(Vec(jackX3, jackY2), module, DryLand::INPUT_CVDRIVE));
	}
