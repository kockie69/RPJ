//***********************************************************************************************
//VuMeter  module for VCV Rack by Robert Kock
//
//Based on code from the Fundamental plugin by Andrew Belt and code from Steve Baker and Marc Boulé 
...
struct VuMeterBase : LightWidget {//OpaqueWidget {
	...
	static constexpr float zeroDbVoltage = 1.0f;// in volts (for track-type)
