...
void Essence::processChannel(int c,Input& in, Output& out) {
...
// First do the knobs
		...
		addParam(createParam<RPJKnob>(Vec(knobX2, knobY1), module, Essence::PARAM_CVFC));	
		addParam(createParam<RPJKnobBig>(Vec(knobX1, knobY2), module, Essence::PARAM_FC));
		addParam(createParam<RPJKnob>(Vec(knobX2, knobY3), module, Essence::PARAM_CVQ));
		addParam(createParam<RPJKnobBig>(Vec(knobX1, knobY4), module, Essence::PARAM_Q));
		addParam(createParam<RPJKnob>(Vec(knobX2, knobY5), module, Essence::PARAM_CVB));
		addParam(createParam<RPJKnobBig>(Vec(knobX1, knobY6), module, Essence::PARAM_BOOSTCUT_DB));
		...
		addInput(createInput<PJ301MPort>(Vec(jackX2, jackY3), module, Essence::INPUT_CVB));
		addInput(createInput<PJ301MPort>(Vec(jackX1, jackY4), module, Essence::INPUT_MAIN));
		addOutput(createOutput<PJ301MPort>(Vec(jackX1, jackY5), module, Essence::OUTPUT_MAIN));	
		addInput(createInput<PJ301MPort>(Vec(jackX2, jackY1), module, Essence::INPUT_CVFC));
		addInput(createInput<PJ301MPort>(Vec(jackX2, jackY2), module, Essence::INPUT_CVQ));
	}
