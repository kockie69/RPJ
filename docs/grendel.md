# Grendel / Quadruple LFO <a name="grendel"></a>
![grendel image](./grendel.png)
...
The four modes of Grendel can be selected by using the selector on the top. The colors of the 4 flashing leds will also indicate the selected mode, being red for FREE, green for QUAD, blue for PHASE and white for DIVIDE.
...
The phase mode is similar to the quad mode except that you can control the amount of phase shift. This can be controlled using the knob for each LFO. Also the CV input can be used to control the phase shift.
