...
DryLand is a Polyphonic module that delivers a first order Low-pass and High-pass filter. The filter is normalized so that the maximum gain is 0.0 dB, and there is no resonant peaking.
